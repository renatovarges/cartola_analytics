...
- Motor de indicações individuais, recorrência e cruzamento com scouts cedidos.
  Desarmes e finalizações exigem ocorrência em pelo menos 60% das aparições,
  com uma das duas mais recentes; G+A exige duas ocorrências, uma nas últimas três.
...
1. Abrir o endereço do site e confirmar que a versão exibida é `2026.09.17-5`.
...
Os testes locais passaram com 52 testes e 9 subtestes. O teste da interface
